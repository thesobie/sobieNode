...
// const researchSubmissionRoutes = require('./researchSubmission'); // Temporarily disabled due to file corruption
...
// router.use('/research-submission', researchSubmissionRoutes); // Temporarily disabled due to file corruption
